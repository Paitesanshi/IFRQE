...
from IFQRE.data.dataset import KGSeqDataset, SequentialDataset
from IFQRE.data.interaction import Interaction
from IFQRE.sampler import SeqSampler
from IFQRE.utils.enum_type import FeatureType
...
class DIENDataset(SequentialDataset):
    """:class:`DIENDataset` is based on :class:`~IFQRE.data.dataset.sequential_dataset.SequentialDataset`.
    ...
    Attributes:
        augmentation (bool): Whether the interactions should be augmented in IFQRE.
        seq_sample (IFQRE.sampler.SeqSampler): A sampler used to sample negative item sequence.
