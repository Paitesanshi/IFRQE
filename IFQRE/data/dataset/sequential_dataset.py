...
from IFQRE.utils.enum_type import FeatureType, FeatureSource


class SequentialDataset(Dataset):
    """:class:`SequentialDataset` is based on :class:`~IFQRE.data.dataset.dataset.Dataset`,
    ...
    def build(self):
        ...
        Args:
            eval_setting (:class:`~IFQRE.config.eval_setting.EvalSetting`):
